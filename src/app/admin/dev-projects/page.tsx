...
import DeleteDevProjectButton from "@/components/admin/DeleteDevProjectButton";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-foreground/60">Manage websites and app projects</p>
        </div>
        <Link
      ...
      {projects.length > 0 ? (
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  <p className="text-foreground/50 text-sm">/dev-projects/{project.slug}</p>
              ...
              <div className="flex items-center gap-3 ml-4">
                ...
                <DeleteDevProjectButton id={project.id} />
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center py-12">
          <p className="text-foreground/60 mb-4">No development projects yet</p>
          <Link
            href="/admin/dev-projects/new"
